...
func (*StreamResponse_Login) Descriptor() ([]byte, []int) {
	return file_protos_chat_proto_rawDescGZIP(), []int{5, 0}
}
...
func (*StreamResponse_Logout) Descriptor() ([]byte, []int) {
	return file_protos_chat_proto_rawDescGZIP(), []int{5, 1}
}
...
func (*StreamResponse_Message) Descriptor() ([]byte, []int) {
	return file_protos_chat_proto_rawDescGZIP(), []int{5, 2}
}
...
func (x *StreamResponse_Shutdown) Reset() {
	*x = StreamResponse_Shutdown{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_chat_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamResponse_Shutdown) Descriptor() ([]byte, []int) {
	return file_protos_chat_proto_rawDescGZIP(), []int{5, 3}
}
...
var file_protos_chat_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x61, 0x69, 0x6e, 0x65, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x63, 0x68, 0x61, 0x74,
...
var file_protos_chat_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
func file_protos_chat_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_chat_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_chat_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_protos_chat_proto_msgTypes[5].OneofWrappers = []interface{}{
